...
public class NetCenter {
    ...
    public static void initBaseHeader() {
        ...
        client.addHeader("Token", BaseRequestHeader.getToken());
     ...
     */
    public static void get(String url, String entity, String contentType,
                           AsyncHttpResponseHandler responseHandler) {
        ...
        sendRequest(GET, url, stringEntity, contentType, responseHandler);
    }
     ...
     * @param responseHandler
     */
    public static void post(String url, String entity, String contentType,
                            AsyncHttpResponseHandler responseHandler) {
        StringEntity stringEntity = null;
        ...
        sendRequest(POST, url, stringEntity, contentType, responseHandler);
    }
